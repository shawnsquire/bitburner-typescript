...
| `run actions/install-augments.js [--confirm] [--script NAME]` | Install and reset. Seeds `hack.strategy=money`, `work.focus=hacking`, `focus.holder=work`, `pserv.autoBuy=true` for the next run. |
